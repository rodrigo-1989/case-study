...
//			return new RespuestaDto(true, "Imagen de usuario subida con exito!",null,null,null,null,null);
//		} catch (Exception e) {
//			log.error("Algo salio mal al guardar la imagen " , e.getMessage());
//			return new RespuestaDto(false,
//					String.format("Algo salio mal, posiblemente el id: %s, del usuario no esta en la BD", idU),null,null,null,null,null);
//		}
//	}
//
//	@Override
...
//			return new RespuestaDto(true, "Imagen de producto subida con exito!",null,null,null,null,null);
//		} catch (Exception e) {
//			log.error("Algo salio mal al guardar la imagen del producto" + e.getMessage());
//			return new RespuestaDto(false,
//					String.format("Algo salio mal, posiblemente el id: %s, del usuario no esta en la BD", idP),null,null,null,null,null);
//		}
//	}
//
...
//	}
	...
	public RespuestaDto eliminarI(String id) {
		try {
			service.delete(id);
			return new RespuestaDto(true, "Eliminación de la imagen sin problema",null,null,null,null,null);
		} catch (Exception e) {
